        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_PurchaseOrderLines_OrderedQuantity", "[OrderedQuantity] > 0");
                    table.CheckConstraint("CK_PurchaseOrderLines_ReceivedQuantity", "[ReceivedQuantity] >= 0 AND [ReceivedQuantity] <= [OrderedQuantity]");
                    table.ForeignKey(
